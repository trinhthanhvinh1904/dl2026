...
All the related functions and the gradient descent algorithm are implemented in the Python file \texttt{Labwork2.ipynb}. The main components of the implementation include:
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{figurelab2.png}
